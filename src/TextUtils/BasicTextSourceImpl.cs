...
namespace TextUtils
{
    public class BasicTextSourceImpl : BasicTextSource
    {
        /// <inheritdoc />
        public BasicTextSourceImpl([NotNull] FontFamily fontFamily, double fontSize, [CanBeNull] Brush? foregroundColor = null) : base(fontFamily, fontSize, foregroundColor)
        {
        }
        ...
        {
            Debug.WriteLine($"{Guid}{nameof(GetTextRun)}: {textSourceCharacterIndex}");
